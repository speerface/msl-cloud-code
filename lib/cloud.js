...
Parse.serverURL = 'http://10.0.0.206/1';
...
var cloud = ( function() {
    ...
    CloudCode.beforeSave( 'Field', function( request, response ) {
        ...
        query.equalTo( 'guid', 'Field-930F07AB-37B7-43D7-8F99-08CC17EB29F2' );
    ...
    CloudCode.define("currentWeatherForFields", function(request, response) {
        ...
        query.find().then(function(objects) {
            ...
            success: response.success( returned_objects );
        }, function(error) {
...
// @return Array  An array of key-value pairs, with dates as keys and GDUs as value (int)
    Parse.Cloud.define('allGDUDataForField', function(request, response) {
...
//
    ...
    function pushErrorMessageToAdministrator(error) {
        ...
        pushQuery.equalTo('currentUser', 'Aaron Abt');
